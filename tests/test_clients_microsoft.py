...
def test_microsoft_graph_oauth2_default_tenant():
    assert client.authorize_endpoint == "https://login.microsoftonline.com/common/oauth2/v2.0/authorize"
    assert client.access_token_endpoint == "https://login.microsoftonline.com/common/oauth2/v2.0/token"
    assert client.refresh_token_endpoint == "https://login.microsoftonline.com/common/oauth2/v2.0/token"
...
def test_microsoft_graph_oauth2_custom_tenant():
    ...
    assert client.authorize_endpoint == "https://login.microsoftonline.com/my_tenant/oauth2/v2.0/authorize"
    assert client.access_token_endpoint == "https://login.microsoftonline.com/my_tenant/oauth2/v2.0/token"
    assert client.refresh_token_endpoint == "https://login.microsoftonline.com/my_tenant/oauth2/v2.0/token"
    assert client.revoke_token_endpoint is None
...
async def test_microsoft_graph_oauth2_authorization_url():
    ...
    authorization_url = await client.get_authorization_url("https://www.tintagel.bt/oauth-callback")
